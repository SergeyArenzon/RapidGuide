...
import { useDeleteTourMutation } from './useDeleteTourMutation'
...
export function TourCard({ tourId, showActions = false }: TourCardProps) {
              ...
              <CardAction>
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem
                      variant="danger"
                      onClick={() => deleteTourMutation.mutate(tourId)}
                    >
